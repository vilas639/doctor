...
*/
    ...
    public void DBCreate(){
        ...
        SQLITEDATABASE.execSQL("CREATE TABLE IF NOT EXISTS demoTable13(id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR);");
    }
    ...
    public void SubmitData2SQLiteDB(){
        ...
        */
        ...
        if(CheckEditTextEmpty == true)
        {
            ...
            SQLiteQuery = "INSERT INTO demoTable13 (name) VALUES('"+Name+"');";
