...
public class Fav5 extends AppCompatActivity {
    ...
    public void DBCreate(){
        ...
        SQLITEDATABASE.execSQL("CREATE TABLE IF NOT EXISTS demoTable15(id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR);");
    }
    ...
    public void SubmitData2SQLiteDB(){
        ...
        */
        ...
        if(CheckEditTextEmpty == true)
        {
            ...
            SQLiteQuery = "INSERT INTO demoTable15 (name) VALUES('"+Name+"');";
