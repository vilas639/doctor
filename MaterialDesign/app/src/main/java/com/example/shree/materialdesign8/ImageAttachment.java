...
public class ImageAttachment extends AppCompatActivity implements Imageutils.ImageAttachmentListener {
    ...
    private void uploadImage(){
        class UploadImage extends AsyncTask<Bitmap,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(ImageAttachment.this, "Uploading...", null,true,true);
            }
            ...
            protected void onPostExecute(final String s) {
                ...
                AlertDialog.Builder alertDialog = new AlertDialog.Builder(ImageAttachment.this);
