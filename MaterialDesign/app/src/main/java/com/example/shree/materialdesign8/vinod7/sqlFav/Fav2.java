...
*/
    ...
    public void DBCreate(){
        ...
        SQLITEDATABASE.execSQL("CREATE TABLE IF NOT EXISTS demoTable10(id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR);");
    }
    ...
    public void SubmitData2SQLiteDB(){
        ...
        */
        ...
        if(CheckEditTextEmpty == true)
        {
            ...
            SQLiteQuery = "INSERT INTO demoTable10 (name) VALUES('"+Name+"');";
